...
export default function Card(props) {
  ...
  return (
    <li className="element">
      ...
      <img src={trash} alt="Icono para eliminar post" className="element__trash" onClick={() => openFull({ children: <RemoveCard title="¿Estás seguro?" onClose={onClose} onCardDelete={onCardDelete} card={card} /> })} />
